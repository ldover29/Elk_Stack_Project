...
- [Filebeat](https://github.com/ldover29/Elk_Stack_Project/blob/main/Ansible/Filebeat/filebeat.yml)
...
| Web VMs  | No                  | Personal IP/10.0.0.4 |
| Elk VM   | No                  | Personal IP/10.0.0.4 |
